                ...
                <div class="">
                    <div class="d-flex justify-content-between gap-2">
                        <div class="form-check style-check d-flex align-items-center">
                            <input class="form-check-input border border-neutral-300" type="checkbox" value="on" id="keep" name="manterLogado">
                            <label class="form-check-label" for="keep">Manter-se conectado </label>
                        </div>
                        <a href="javascript:void(0)" class="text-primary-600 fw-medium">Esqueceu sua senha?</a>
                    </div>
                </div>
