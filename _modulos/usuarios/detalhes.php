                ...
                <div class="col-xxl-6 col-xl-8 col-lg-10">
                    <div class="card border">
                        <div class="card-body">
                            ...
                            <form method="post">
                                <input type="hidden" value="<?= $detalhesUsuario['id'] ?>" name="id_usuario">
                                <div class="mb-20">
                                    <label
                                        for="name"
                                ...
                                <?php if ($detalhesUsuario['startup'] != 1) { ?>
                                    <div class="mb-20">
                                        <label
                                            for="desig"
                                        ...
                                        <select
                                            ...
                                            id="startup"
                                            name="startups">
                                            <option value="" <?= ($detalhesUsuario['startup'] == 0 ? "selected" : "") ?>>Startup ainda não cadastrada</option>
